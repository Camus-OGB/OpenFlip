...
async def get_page_image(doc_id: str, page_num: int, token: str = None, session: Session = Depends(get_session)):
    """
...
async def get_reader_data(doc_id: str, token: str = None, session: Session = Depends(get_session)):
    """
